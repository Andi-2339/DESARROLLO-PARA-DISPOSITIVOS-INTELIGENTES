            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text(ap.errorMessage ?? 'Error desconocido', textAlign: TextAlign.center),
                  const SizedBox(height: 24),
                  ElevatedButton(onPressed: ap.connect, child: const Text('Reintentar')),
                ],
              ),
            );
          }
            ...
            return Center(
              child: Column(
                ...
                children: [
                  ...
                  Text('Asegúrate de que la app del wearable esté activa', style: TextStyle(color: Colors.grey[600])),
            ...
            child: Column(
              children: [
                ...
                GridView.count(
                  ...
                  children: [
                    MetricCard(
                        label: 'PASOS', value: '${d.steps}', unit: 'pasos', color: Colors.green, icon: Icons.directions_walk),
                    MetricCard(
                        ...
                        icon: Icons.favorite),
                    MetricCard(
                        label: 'CALORIAS', value: '${d.calories}', unit: 'kcal', color: Colors.orange, icon: Icons.local_fire_department),
                    MetricCard(
                        label: 'ZONA FC',
                        value: d.heartRateZone.split(' ').first,
                        unit: d.heartRateZone.contains(' ') ? d.heartRateZone.split(' ').skip(1).join(' ') : '',
                        color: Colors.purple,
                        icon: Icons.speed),
                  ],
                ),
